...
<div class="container">
    ...
    <form action="<?php echo site_url('pegawai/store'); ?>" method="post">
        <label for="nama">Nama</label>
        <input type="text" id="nama" name="nama" value="<?php echo set_value('nama'); ?>">

        <label for="jabatan">Jabatan</label>
        <input type="text" id="jabatan" name="jabatan" value="<?php echo set_value('jabatan'); ?>">

        <label for="divisi_id">Divisi</label>
        <select id="divisi_id" name="divisi_id">
            <option value="">-- Pilih Divisi --</option>
            <?php foreach ($divisi as $d): ?>
                <option value="<?php echo $d->id; ?>" <?php echo set_select('divisi_id', $d->id); ?>>
        ...
        <input type="text" id="no_hp" name="no_hp" value="<?php echo set_value('no_hp'); ?>">
